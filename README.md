...
<p align="center">
  <code>Версия 4.1.2</code> · <code>Windows</code> · <code>Python 3.11</code> · <code>PySide6</code> · <code>SQLite</code> · <code>MIT</code> · <code>Экспериментальный проект</code>
</p>
...
<p align="center">
  <img src="docs/assets/readme/remcard-workflow.svg" width="100%" alt="Врач, медсестра и оперблок работают с общей папкой данных, медицинской БД, настройками и резервными копиями">
</p>
