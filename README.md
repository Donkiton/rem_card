...
Если проект заинтересовал, можно написать на [security@example.invalid](mailto:security@example.invalid) с темой письма `РЕМ КАРТА`. Я с радостью расскажу, как это творение работает.
