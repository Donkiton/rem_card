...
class Sector3b(BaseSectorWidget):
    ...
    def init_ui(self):
        ...
        set_widget_style(self.total_out_val, "font-weight: bold; color: #28a745; font-size: 14px; border: none; background: transparent;")
    ...
    def add_balance_row(self, title, icon_name):
        ...
        unit_lbl = QLabel("мл")
        set_widget_style(unit_lbl, "font-weight: 600; color: #495057; font-size: 12px; border: none; background: transparent;")
