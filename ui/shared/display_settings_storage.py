...
# Factory layout: independent of database contents and bundled settings files.
SECTOR8_BUTTONS: dict[str, tuple[dict[str, Any], ...]] = {
    "doctor": (
        {
            "id": "user_report", "label": "Репорт",
            "default_visible": True, "can_hide": True,
            "default_side": SECTOR8_BUTTON_SIDE_LEFT,
        },
        {
            "id": "user_reports", "label": "Репорты",
            "default_visible": False, "can_hide": True,
            "default_side": SECTOR8_BUTTON_SIDE_LEFT,
        },
        {
            "id": "roles", "label": "Роли",
        ...
        {
            "id": "emergency_mode", "label": "Аварийный режим (только при аварии)",
            "default_visible": True, "can_hide": True,
            "default_side": SECTOR8_BUTTON_SIDE_LEFT,
        },
        {
            "id": "add_patient", "label": "Добавить пациента",
            "default_visible": True, "can_hide": True,
            "default_side": SECTOR8_BUTTON_SIDE_RIGHT,
        },
        {
...
REMCARD_TABS: dict[str, tuple[dict[str, Any], ...]] = {
    "doctor": (
        ...
        {"id": "oral_nutrition", "label": "Диета", "default_visible": True},
